...
class VehiclePIDController():
    ...
    def run_step(self, traget_speed, waypoint):
...
def main():
    ...
    try:
        ...
        #------Basic setup for vehicle------
        blueprint_library = world.get_blueprint_library()
        vehicle_bp = blueprint_library.filter('cybertruck')[0]
        spawnpoint = carla.Transform(carla.Location(x=-75.4,y=-1.0,z=15),carla.Rotatiom(pitch = 0,yaw = 180,roll = 0))
        ...
        while True:
            ...
            camera_trasform = carla.Transform(carla.Location(x=1.5,y=2.4))
            camera = world.spawn_actor(camera_bp, camera_trasform)
            ...
            depth_camera_trasform = carla.Transform(carla.Location(x=1.5,y=2.4))
            depth_camera = world.spawn_actor(depth_camera_bp, depth_camera_trasform)
